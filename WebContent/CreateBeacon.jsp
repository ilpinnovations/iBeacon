...
<body>
	...
	<div class="container">
		...
		<div class=' panel-heading'>
			<i class="fa fa-user-plus fa-1x"></i> &nbsp; Add beacon
		</div>
		<form action='CreateBeacon' method="post" name="userRegForm"
			...
			<div class="form-group">
				<label class="col-lg-3 control-label">Beacon Name</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="beaconName"
						placeholder="Beacon name here" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">Major ID</label>
				<div class="col-lg-5">
					<input type="number" class="form-control" name="major"
						placeholder="Major ID here" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">Minor ID(Optional)</label>
				<div class="col-lg-5">
					<input type="number" class="form-control" name="minor"
						placeholder="Minor ID here" />
				</div>
			</div>
			<div class="form-group">
